...
public class RegistroHuesped extends JFrame {
	...
	public RegistroHuesped(int idReserva) {
		...
		lblNewLabel_4.setBounds(555, 55, 350, 42);
	...
	private void guardarHuesped() {
			...
			if (txtFechaN.getDate() != null && !txtNombre.equals("") && !txtApellido.equals("") && !txtTelefono.equals("")) {		
				...
				Invitados invitados = new Invitados(txtNombre.getText(), txtApellido.getText(),  java.sql.Date.valueOf(fechaN), txtNacionalidad.getSelectedItem().toString(),txtTelefono.getText(), nreserva);
				this.huespedesController.guardar(invitados);
